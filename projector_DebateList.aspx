...
<asp:Content ID="ContentBottom" ContentPlaceHolderID="CoPlaBottom" Runat="Server">
    ...
    <div id="linkreuse" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-body">
            <p>Der folgende Link dient dazu deine gefilterte Ansicht wiederzuverwenden. Er öffnet also die Liste mit den jetzt gültigen Suchkriterien.</p>
            <br />
            <div><a id="extLinkDisplay"></a></div>
            <br />
            <input type="image" id="post_on_diaspora" class="btn" src="style/pic/diaspora_icon_64x64.png" style="height:48px; width:48px;" data-toggle="tooltip" title="Teilen auf *diaspora"/>
            <input type="image" id="post_on_facebook" class="btn" src="style/pic/facebook_icon_64x64.png" style="height:48px; width:48px;" data-toggle="tooltip" title="Teilen auf facebook"/>
            <br />
        </div>
        <div class="modal-footer">
